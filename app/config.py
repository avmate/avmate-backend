...
class Settings:
    ...
    enable_llm_answers: bool = _as_bool(os.getenv("ENABLE_LLM_ANSWERS"), default=True)
    enable_llm_query_assist: bool = _as_bool(os.getenv("ENABLE_LLM_QUERY_ASSIST"), default=True)
